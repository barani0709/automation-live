    ...
    for (const division of divisions) {
      ...
      try {
        ...
        for (const month of selectedMonths) {
          ...
          try {
            await page.goto('https://elbrit.ecubix.com/Apps/Report/frmCallAvg.aspx?a_id=353', {
              timeout: 60000,
              waitUntil: 'domcontentloaded'
            });

            // await page.locator('xpath=//*//*[@id="aspnetForm"]/div[9]/div/div/header/div[2]/a').click();
            ...
            await page.locator('#ctl00_CPH_chkIncludeIndividualNW').check();//*[@id="ctl00_CPH_chkIncludeIndividualNW"]
            ...
            await page.locator('#ctl00_CPH_btnDownload').click();//*[@id="ctl00_CPH_btnDownload"]
            const download = await downloadPromise;

            const fileName = `call_avg_${division}_${month}-${year}.csv`;
